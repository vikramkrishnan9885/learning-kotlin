...
echo "Move jar to s3 ..."
aws s3 cp target/original-greeter-1.0.0.jar s3://vk-serverless-20200201/original-greeter-1.0.0.jar  --profile personal
cd ..
...
aws lambda create-function \
    ...
    --code S3Bucket=vk-serverless-20200201,S3Key=original-greeter-1.0.0.jar \
    --timeout 15 \
    --memory-size 512 \
    --profile personal
